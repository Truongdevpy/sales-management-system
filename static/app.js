...
const DB = {
    users: [
        { id: 3, name: 'Admin System', email: 'admin@demo.com', role: 'admin', avatar: 'A' },
        { id: 1, name: 'Nguyễn Tuấn', email: 'tuannt03', role: 'seller', avatar: 'S', shopName: 'Nguyễn Tuấn Shop' },
        { id: 2, name: 'Mary Customer', email: '1', role: 'customer', avatar: 'C' }
    ],
    sellers: [ // Seller details
        { id: 1, userId: 1, shopName: 'Nguyễn Tuấn Shop', status: 'approved', joinedAt: '2026-04-03', totalProducts: 3, totalSales: 0 }
    ],
    sellerRequests: [
    ...
    products: [
        { id: 1, sellerId: 1, name: 'Wireless Headphones', price: 99000, stock: 50, category: 'Electronics', status: 'active', image: 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=300&q=80' },
        { id: 2, sellerId: 1, name: 'Smart Watch', price: 199000, stock: 30, category: 'Electronics', status: 'active', image: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&w=300&q=80' }
    ],
    orders: [
        { id: 1001, customerId: 2, totalAmount: 299000, paymentStatus: 'paid', shippingStatus: 'delivered', createdAt: '2023-11-10' }
    ],
    orderItems: [
...
function renderSidebarMenu(role, currentPage) {
    ...
    if (role === 'admin') {
        html += `
            ...
            <a href="/customer-management" class="menu-item ${currentPage === 'customer-management' ? 'active' : ''}">
                <i class='bx bx-user-detail'></i> Customers
            </a>
        `;
    }
    ...
    if (role === 'seller') {
        html += `
            ...
            <a href="/seller-bank-config" class="menu-item ${currentPage === 'seller-bank-config' ? 'active' : ''}">
                <i class='bx bx-credit-card'></i> Bank API Config
            </a>
        `;
    }
